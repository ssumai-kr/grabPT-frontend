...
function Layout() {
  ...
  return (
    <div className="flex h-screen flex-col">
      ...
      <section className="flex min-h-0 flex-1 basis-0 [transform:translateZ(0)] flex-col justify-between overflow-y-scroll [will-change:transform] [contain:layout_paint]">
