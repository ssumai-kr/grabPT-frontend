...
const mockRequests: RequestCardProps[] = [
  {
    nickname: '날다람주날닮았쥐',
    region: '서울시 강서구 화곡동',
    center_name: '응암동헬스장 브라이언박 트레이닝 센터',
