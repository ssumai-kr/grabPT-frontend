    ...
    <>
      <div className="relative flex h-[50px] w-[600px] items-center justify-between rounded-[10px] bg-[#EFEFEF]">
        <div className="w-[140px] text-center">
          {CertificationCode ? codeMap[CertificationCode] || CertificationCode : '수상'}
        </div>
...
export const CertificationEditCard = ({ onAdd }: CertificationEditCardProps) => {
