      ...
      <div className="flex w-full flex-col gap-12">
        ...
        <div>
          ...
          <div className="mt-3.5 flex gap-2">
            <input type="checkbox" aria-label="직접 입력" className="accent-button" />
            <span className="mr-3 text-base font-medium">직접 입력</span>
            <input type="checkbox" aria-label="새로운 가격 제안" className="accent-button" />
          ...
          <div className="mt-3.5 flex items-center">
            <input
              ...
              value={10}
              readOnly
              className="mr-1.5 h-12 w-[85px] rounded-xl border-2 border-[#BABABA] pl-3.5 text-center text-2xl font-normal text-[#9F9F9F]"
            />
            ...
            <input
              ...
              aria-label="희망 PT 가격"
              readOnly
              className="mr-1.5 h-12 w-[260px] rounded-xl border-2 border-[#BABABA] px-8 text-end text-2xl font-normal text-[#9F9F9F]"
            />
